...
function LoginForm() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      let next = searchParams.get("callbackUrl") || "/admin/furgonetas";
      if (!next.startsWith("/")) next = "/admin/furgonetas";
  ...
  return (
    <section className="mx-auto max-w-md py-12 px-4 space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 mt-2">Accedeix al panell d'administració</p>
      </div>
