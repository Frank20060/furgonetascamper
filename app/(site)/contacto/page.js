          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#1a3a34] text-lg leading-relaxed">
                ¿Tienes dudas sobre nuestras furgonetas o quieres un presupuesto
                personalizado? Estamos aquí para ayudarte a dar el primer paso
                hacia la libertad sobre ruedas.
              </p>
            </div>
            ...
            <div className="space-y-6 pt-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-heading text-sm uppercase tracking-wider text-[#102C26] font-bold">
                    Ubicación
                  </h4>
                  <p className="text-[#1a3a34]">
                    Calle de la Aventura, 123, 08001 Barcelona
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
